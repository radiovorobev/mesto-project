...
export const avatarInputList = Array.from(avatarForm.querySelectorAll(validationSetup.inputSelector));
export const avatarSubmit = avatarForm.querySelector(validationSetup.submitButtonSelector);
...
export const profileSubmit = profileForm.querySelector(validationSetup.submitButtonSelector);
...
export const newCardFormInputList = Array.from(newCardForm.querySelectorAll(validationSetup.inputSelector));
export const newCardFormSubmit = newCardForm.querySelector(validationSetup.submitButtonSelector);
